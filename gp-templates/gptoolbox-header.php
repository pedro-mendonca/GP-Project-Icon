...
<div class="gp-heading">
	...
	<div class="gp-project-icon-tools">
		<?php
		...
		foreach ( $tools_pages as $tools_page ) {
			...
			$class = 'gp-project-icon-tool-link';
...
<div class="notice notice-info">
	...
	echo wp_kses_post(
		sprintf(
			...
			__( '<strong>Attention:</strong> Before cleaning any data, please make sure you %1$sbackup your database%2$s first, as any deletion of data will be irreversible.', 'gp-project-icon' ),
